...
def Drude(drudeinput):
	...
	if isdrude==1:	
		...
		eps =eps+ wp**2/(1E0+j*gamma* myglobalparameters.w-myglobalparameters.w**2)		
		interm= interm+2
...
np.savetxt(fileoutputfreq,outputfreq,header="Freq \t E-field \t real part of fitted epsilon \t imaginary part of fitted epsilon \t real part of fitted n \t imaginary part of fitted n \t real part of initial epsilon \t imaginary part of initial epsilon \t real part of initial n\t imaginary part of initial n")
